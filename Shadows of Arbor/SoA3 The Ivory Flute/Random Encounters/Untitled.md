...
- Roll or choose this encounter when: During the Ivory Flute Adventure or just after it.

### Initial State

- **Awareness:** The Players notice the situation
- **Disposition:** This depends a lot on the current state the players have made with the Green Cloaks and general populace for the most part though this would be neutral.
- **Starting action:** The crowd is advancing slowly towards the barricade.

### Terrain and Conditions

- **Features:** Several elevated side terraces along with a number of overturned carriages some of which are currently on fire.
- **Cover / elevation / exits:** Lots of cover two main exits at the north and south end
- **Hazards:** The fire and the rioters should they charge
- **Light / weather / visibility:** Fog and smoke reduced visibility 
...
- Primarily to get away from the zombies before more are infected, but they will drag the players along with them if need be.
