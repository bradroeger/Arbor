...
- The power source for all of this is a trapped angel, the creature has been imprisoned for a long time and itÃ¢â‚¬â„¢s primary food source was the salt the machine made as a by product.
...
## Atmosphere
- Sounds: The Thrum and Vibration of the engine and in the distance the swirling sound of water in a torrent.
- Smells: Salt, burning and ozone
- Taste: In the water is a high concentration of salt
- Lighting: The furnace produces a small amount of light and heat and the prisoner does much the same.

---

## GM Notes
- - The Functions of the engine room
    - Filter the water provided by the hole into the Elemental Plane of Water into Fresh Water
...
- **DC 25 Perception Check** on the Cage:
	- *At the bottom of the cage you seem to see something through the steam. At first only two pin pricks of red light burn through the haze but eventually you can make out a humanoid woman with large soot coloured wings, red hair the colour of fire and armour though it has seen far better days. 
- **Dispel Magic DC 17:** 
	- To break the seal on the cage using **Dispel Magic.**
- **Boiler Toughness 20:
	- Disable the boiler, either with tools or a hammer. 
- **TinkerÃ¢â‚¬â„¢s Tools DC 25:**
	- To understand the mechanisms of the machine how it works what it does and importantly how to change the flow and direction of water in the system. The Duchess does not like the heat from the Tropical area itÃ¢â‚¬â„¢s why itÃ¢â‚¬â„¢s been largely left alone by her. ItÃ¢â‚¬â„¢s possible the players could use this to stave her off if they understand this.
...
- [[Ephemera]] is imprisoned and mentally broken. The boiler heat is the immediate environmental threat.

---

## Secrets

- Ephemera's sword lies buried beneath the rubble.
